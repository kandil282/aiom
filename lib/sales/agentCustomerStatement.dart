...
class Agentcustomerstatement extends StatefulWidget {
  final dynamic agentId;

  const Agentcustomerstatement({super.key, this.agentId});

  @override
  State<Agentcustomerstatement> createState() => _AgentcustomerstatementState();
}

class _AgentcustomerstatementState extends State<Agentcustomerstatement> {
